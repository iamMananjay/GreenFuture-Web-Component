...
const Project = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold text-purple-800 mb-8 text-center">Project Overview</h1>
  ...
  <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
    <div className="bg-gradient-to-r from-purple-600 to-purple-700 p-8 rounded-xl shadow-2xl w-[600px]">
      <h2 className="text-3xl font-bold text-white mb-6 text-center">
        {editMode ? "Edit Project" : "Add New Project"}
      </h2>
      <form onSubmit={handleAddOrUpdateProject}>
        <div className="mb-6">
          <label className="block text-gray-200 text-lg mb-2">Project Name</label>
          <input
            type="text"
            name="name"
        ...
        <div className="mb-6">
          <label className="block text-gray-200 text-lg mb-2">Team</label>
          <select
            name="team"
        ...
        <div className="mb-6">
          <label className="block text-gray-200 text-lg mb-2">Idea</label>
          <select
            name="idea"
        ...
        <div className="mb-6">
          <label className="block text-gray-200 text-lg mb-2">Status</label>
          <select
            name="stage"
